...
module.exports = __webpack_require__(/*! C:\Users\Renato\Desktop\Loja\src\main.ts */"zUnb");
...
const routes = [
    ...
    {
        path: 'my-account',
        loadChildren: () => __webpack_require__.e(/*! import() | my-account-my-account-module */ "my-account-my-account-module").then(__webpack_require__.bind(null, /*! ./my-account/my-account.module */ "J8OZ")).then(m => m.MyAccountPageModule)
    },
    {
        path: 'tabs',
